...
public class FrmMenu extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    jLabel1.setIcon(new javax.swing.ImageIcon(getClass()
        .getResource("/Hilos/usuarios.png"))); // NOI18N
  ...
  private void mniDocenteNuevoActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniDocenteNuevoActionPerformed
    FrmNuevoDocente dialog = new FrmNuevoDocente(this, true);
    dialog.setVisible(true);
  } //GEN-LAST:event_mniDocenteNuevoActionPerformed

  private void mniEstudianteNuevoActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniEstudianteNuevoActionPerformed
    FrmNuevoEstudiante dialog = new FrmNuevoEstudiante(this, true);
    dialog.setVisible(true);
  } //GEN-LAST:event_mniEstudianteNuevoActionPerformed

  private void mniDocenteEditarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniDocenteEditarActionPerformed
    FrmBuscarDocente dialog = new FrmBuscarDocente(new javax.swing.JFrame(), true);
    dialog.setVisible(true);
  } //GEN-LAST:event_mniDocenteEditarActionPerformed

  private void mniEstudianteEditarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniEstudianteEditarActionPerformed
  ...
  private void mniDocenteVisualizarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniDocenteVisualizarActionPerformed
    FrmVisualizarDocente dialog = new FrmVisualizarDocente(this, true);
  } //GEN-LAST:event_mniDocenteVisualizarActionPerformed

  private void mniEstudianteVisualizarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniEstudianteVisualizarActionPerformed
  ...
  private void mniDocenteEliminarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniDocenteEliminarActionPerformed
  ...
  private void mniEstudianteEliminarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniEstudianteEliminarActionPerformed
  ...
  private void mniSalirActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniSalirActionPerformed
    System.exit(0);
  } //GEN-LAST:event_mniSalirActionPerformed

  private void mniAcercaDeActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniAcercaDeActionPerformed
    JOptionPane.showMessageDialog(null, "Creado por María Belén Vargas Cevallos"
                + "\nVersión 1.0");
  } //GEN-LAST:event_mniAcercaDeActionPerformed

  private void mniConserjeNuevoActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniConserjeNuevoActionPerformed
    FrmNuevoConserje dialog = new FrmNuevoConserje(this, true);
    dialog.setVisible(true);
  } //GEN-LAST:event_mniConserjeNuevoActionPerformed

  private void mniConserjeVisualizarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniConserjeVisualizarActionPerformed
  ...
  private void mniConserjeEditarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniConserjeEditarActionPerformed
  ...
  private void mniConserjeEliminarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniConserjeEliminarActionPerformed
  ...
  private void mniDocenteGuardarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniDocenteGuardarActionPerformed
  ...
  private void mniEstudianteGuardarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniEstudianteGuardarActionPerformed
  ...
  private void mniConserjeGuardarActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniConserjeGuardarActionPerformed
  ...
  private void mniDocenteAbrirActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniDocenteAbrirActionPerformed
    FrmAbrirDocente dialog = new FrmAbrirDocente(this, true);
  } //GEN-LAST:event_mniDocenteAbrirActionPerformed

  private void mniEstudianteAbrirActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniEstudianteAbrirActionPerformed
    FrmAbrirEstudiante dialog = new FrmAbrirEstudiante(this, true);
  } //GEN-LAST:event_mniEstudianteAbrirActionPerformed

  private void mniConserjeAbrirActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniConserjeAbrirActionPerformed
    FrmAbrirConserje dialog = new FrmAbrirConserje(this, true);
  } //GEN-LAST:event_mniConserjeAbrirActionPerformed

  private void mniCarreraActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniCarreraActionPerformed
  ...
  private void mniAbrirBEstudianteActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniAbrirBEstudianteActionPerformed
  ...
  private void mniAbrirBDocenteActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniAbrirBDocenteActionPerformed
  ...
  private void mniAbrirBConserjeActionPerformed(java.awt.event.ActionEvent evt) { 
    //GEN-FIRST:event_mniAbrirBConserjeActionPerformed
  ...
  private void mniLeerDocenteActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniLeerDocenteActionPerformed
    FrmLeerDocente dialog = new FrmLeerDocente(new javax.swing.JFrame(), true);
    dialog.setVisible(true);
  } //GEN-LAST:event_mniLeerDocenteActionPerformed

  private void mniLeerEstudianteActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniLeerEstudianteActionPerformed
  ...
  private void mniLeerConserjeActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniLeerConserjeActionPerformed
    FrmLeerConserje dialog = new FrmLeerConserje(new javax.swing.JFrame(), true);
    dialog.setVisible(true);
  } //GEN-LAST:event_mniLeerConserjeActionPerformed

  private void mniGuardarBDocenteActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniGuardarBDocenteActionPerformed
  ...
  private void mniGuardarBConserjeActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniGuardarBConserjeActionPerformed
  ...
  private void mniGuardarBEstudianteActionPerformed(java.awt.event.ActionEvent evt) {
    //GEN-FIRST:event_mniGuardarBEstudianteActionPerformed
