...
public class FrmAbrirBConserje extends javax.swing.JDialog {
  ...
  @SuppressWarnings("unchecked")
    ...
    tblContenido.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cedula", "Nombre", "Sexo", "Fecha Nac", "Teléfono", "Dirección", 
                "Edad", "Fecha Ingreso", "Turno", "Instrucción", "Sector", "Años Servicio", 
                "Pago Mensual"
            }
        ) {
    ...
    layout.setHorizontalGroup(
            ...
            734, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblTotal1, javax.swing.GroupLayout.PREFERRED_SIZE, 
