...
public class FrmEditarEstudiante extends javax.swing.JDialog {
  ...
  @SuppressWarnings("unchecked")
    ...
    layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(frmFormatEstudiante, javax.swing.GroupLayout.PREFERRED_SIZE, 
  ...
  private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    String nombre = frmFormatEstudiante.getTxtNombre().getText().trim();
    String sexo = (String) frmFormatEstudiante.getCmbSexo().getSelectedItem();
    String telefono = frmFormatEstudiante.getTxtTelefono().getText().trim();
    String direccion = frmFormatEstudiante.getTxtDireccion().getText().trim();
    String carrera = (String) frmFormatEstudiante.getCmbCarrera().getSelectedItem();
    String semestre = (String) frmFormatEstudiante.getCmbSemestre().getSelectedItem();
    String materia = frmFormatEstudiante.getTxtMateria().getText().trim();
